...
class BASE32 {
  ...
  static function fileSHA1($file) {
    ...
    return BASE32::base32encode($raw);
  } //fileSHA1
  ...
  static function base32encode($input) {
    ...
    while ($index < strlen($input)) {
      ...
      while ($storedBitCount >= 5) {
        $storedBitCount -= 5;
        $output .= BASE32::$BASE32_ALPHABET[$storedData >> $storedBitCount];
    ...
    if ($storedBitCount > 0) {
      ...
      $output .= BASE32::$BASE32_ALPHABET[$storedData];
    }
...
//Test
//echo BASE32::fileSHA1('FreeSerif.ttf');
